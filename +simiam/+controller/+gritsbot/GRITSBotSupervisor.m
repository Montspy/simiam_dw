classdef GRITSBotSupervisor < simiam.controller.Supervisor
...
%         is_init
    ...
    %% METHODS
        ...
        function obj = GRITSBotSupervisor()
        %% SUPERVISOR Constructor
            ...
            obj.controllers{4} = simiam.controller.AOandGTG_kine();
...
%                 fprintf('stopped at (%0.3f,%0.3f)\n', x, y);
                ...
                obj.switch_to_state('ao_and_gtg_kine');
            end
