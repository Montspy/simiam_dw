classdef BRSupervisor < simiam.controller.Supervisor
...
%         is_init
    ...
    %% METHODS
        ...
        %% SUPERVISOR Constructor
            ...
            obj.controllers{4} = simiam.controller.AOandGTG_test();
...
%                 fprintf('stopped at (%0.3f,%0.3f)\n', x, y);
                ...
                obj.switch_to_state('ao_and_gtg_test');
            end
